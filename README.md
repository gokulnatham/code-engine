...
- dockerfile-strategy folder contains sample application (or job) copied from https://github.com/IBM/CodeEngine/tree/main/helloworld
  Note: this component can be deployed as an application or a job
